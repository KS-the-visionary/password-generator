...
def main(page: ft.Page):
    ...
    generate_btn = ft.Container(width=200, height=50, left=common_x-50, top=150, content=ft.FloatingActionButton(bgcolor="#ff5050", shape=ft.RoundedRectangleBorder(radius=30), content=ft.Text("Generate Password", font_family="interFont", size=15, weight=ft.FontWeight.W_500), on_click=lambda _: make_password()))
